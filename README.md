...
The first merged build established the **Level 1 Discover foundation**:
...
Do not start the executable spatial-workbench milestone until the system can answer these questions from real source evidence:
